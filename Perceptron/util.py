...
#change labels to numbers. N = -1 and Y = 1
...
def pre_process_data(data, limit=None):
    ...
    #convert labels to -1 and 1 because that's the label of the perceptron model
    data.loc[data['Loan_Status'] == "N", 'Loan_Status'] = -1
